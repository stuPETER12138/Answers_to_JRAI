...
class Metaclass_Money(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _money
...
class Money(metaclass=Metaclass_Money):
    from interfaces.srv._money import Money_Request as Request
    from interfaces.srv._money import Money_Response as Response
